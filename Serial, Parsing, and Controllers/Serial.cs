...
//https://forum.arduino.cc/index.php?topic=467421.0
using UnityEngine;
...
//				case RuntimePlatform.OSXPlayer:
	...
	public IEnumerator ReadSerialLoop ()
	{
		...
		while (true) {
            ...
            print("bytes: " + s_serial.BytesToRead);

            //if(s_serial.BytesToRead < 1){
...
//				s_serial.RtsEnable = true; // ** Nick Added
	...
	static string GetPortName ()
	{
		...
		case RuntimePlatform.LinuxPlayer:
			...
			if (portNames.Count == 0) {
				// don't allow BT connections, for now
